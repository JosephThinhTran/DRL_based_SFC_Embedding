# -*- coding: utf-8 -*-
"""
Created on Tue Feb 21 23:30:40 2022

@author: Onlyrich-Ryzen

Implement Decentralized Advantage Actor Critic (A2C) learning main loop
    + Service Function Chain Embedding problem
    + EDF network environment

- Changelog:
    + Modified from AC_SFC_Main_01.05.py
...
from dec_ac_models_v01 import ACNet, A3CWorker, SharedAdam, SharedRMSProp
from edf_env_MARL_v1_01 import EdfEnv # copied from edf_env_A3C_v2_02 import EdfEnv
#from data_utils_A3C_02 import retrieve_sfc_req_from_json, mov_window_avg
from data_utils_MARL_01 import retrieve_sfc_req_from_json, mov_window_avg
from datetime import datetime
from pathlib import Path
import json
import shutil
import argparse
from dataset_and_params_DecAC import get_sfc_spec_file, get_train_datasets, get_test_datasets, get_train_test_params
from plot_results_MARL import plot_episode_rwd, plot_loss_val, plot_accum_accept_req
from plot_results_MARL import plot_throughputs, plot_rsc_usages, plot_delay_stress_level
...
if __name__ == "__main__":
    #### Parsing arguments
    parser = argparse.ArgumentParser(description="Decentralized AC-based MARL SFC Embedding")
    ...
    parser.add_argument("--n_workers", default=1, type=int, help="Number of parallel workers. Support upto 12")
    ...
    parser.add_argument("--model_dir", default="Dec_AC_SFCE_models", type=str, help="Directory storing the model")
    parser.add_argument("--model_name", default="DecAC_Agent", type=str, help="Name of the model")
    ...
    parser.add_argument("--en_log", default=False, type=bool, help="Enable/Disable exporting training/testing log to file. Options: True/False")
