...
from data_utils_02 import build_net_topo, build_node_info, get_vnf_specs, get_sfc_specs, build_vnf_support
from data_utils_02 import build_neighbors, init_resource, init_bw
...
class EdfEnv(object):
    ...
    def reward(self, real_action, residual_delay, proc_latency, 
        ...
        '''
        # print("TODO: Calculate the reward!")
        big_reward = 3
        # Old cost factors
        # beta1 = 0.01
        # beta2 = 0.001
